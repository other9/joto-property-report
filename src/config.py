...
# 健美家URLパス: pp1=区分マンション pp2=一棟アパート pp4=一棟ビル pp6=店舗 pp8=戸建て
PROPERTY_CATEGORIES = {
...
RENT_DATA_BY_CATEGORY = {
    "condo": {
        ...
        "data":{
            ...
            "文京区":{"1R":9.8,"1K":10.5,"1DK":12.0,"1LDK":16.0,"2LDK":22.0,"3LDK":28.0},
            "大田区":{"1R":7.5,"1K":8.2,"1DK":9.5,"1LDK":12.5,"2LDK":16.0,"3LDK":20.0},
    ...
    "house": {
        ...
        "data":{
            ...
            "文京区":{"2LDK":24.0,"3LDK":30.0,"4LDK":38.0},
            "大田区":{"2LDK":17.0,"3LDK":22.0,"4LDK":27.0},
    ...
    "apart": {
        ...
        "data":{
            ...
            "文京区":{"1R":9.0,"1K":9.5,"1DK":10.5,"2DK":13.0},
            "大田区":{"1R":7.0,"1K":7.5,"1DK":8.5,"2DK":10.5},
    ...
    "building": {
        ...
        "data":{
            ...
            "文京区":{"坪単価（事務所）":1.6,"坪単価（店舗1F）":2.8},
            "大田区":{"坪単価（事務所）":1.1,"坪単価（店舗1F）":1.8},
    ...
    "store": {
        ...
        "data":{
            ...
            "文京区":{"坪単価":2.5,"20㎡":"12〜16","40㎡":"25〜32","60㎡":"38〜48"},
            "大田区":{"坪単価":1.6,"20㎡":"8〜10","40㎡":"16〜21","60㎡":"24〜32"},
