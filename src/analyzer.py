...
from config import (BUDGET,LOAN_PARAMS,SCORING_WEIGHTS,CLAUDE_MODEL,CLAUDE_MAX_TOKENS,
                    ...
                    TOTAL_EXPENSE_RATIO,ACQUISITION_COST_RATIO,MIN_NET_YIELD,
                    MAX_DISPLAY,MAX_CLAUDE_INPUT)
...
2. 入力された物件すべてを評価し、最大{MAX_DISPLAY}件をスコア降順で返す（同一物件の重複禁止、urlは元データからコピー）
